...
function t10() {
	let data1 = document.querySelector('.i-10').value;
	document.querySelector('.out-10').textContent = data1 * 20;
}
...
function t11() {
	let data2 = document.querySelector('.i-11').value;
	document.querySelector('.out-11').textContent = data2 + 55;
}
...
function t12() {
	let myName = document.querySelector('.i-12-1').value;
	let mySurname = document.querySelector('.i-12-2').value;
	document.querySelector('.out-12').textContent = 'Hello ' + myName + " " + mySurname;
...
function t15() {
	document.getElementsByClassName('i-15')[0].style.border = "4px solid red";
}
...
function t17() {
	...
	document.querySelector('.out-17-1').textContent = +a;
	document.querySelector('.out-17-2').textContent = parseInt(a, 10);
...
function t18() {
	let xInt = parseFloat(document.querySelector('.i-18').value);
	document.querySelector('.out-18').textContent = xInt;
}
