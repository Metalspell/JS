...
function f5() {
	...
	if (myCheck.checked) {
		document.querySelector('.out-5').innerHTML = myCheck.value;
	} else {
...
function f7() {
	let userPassword = document.querySelector('.i-7');
	document.querySelector('.out-7').innerHTML = userPassword.value;
...
function f9() {
	let myCheck = document.querySelector('.r-9');

	if (myCheck.checked) {
		document.querySelector('.out-9').innerHTML = myCheck.value;
	} else {
...
function f10() {
	...
	document.querySelector('.out-10').style.background = color.value;
}
...
function f11() {
	let color = document.querySelector('.i-111');
	document.querySelector('.i-112').value = color.value;
}
...
function f12() {
	...
	document.querySelector('.out-12').innerHTML = date.value;
}
...
function f13() {
	...
	document.querySelector('.out-13').innerHTML = data.value;
}
...
function f14() {
	...
	document.querySelector('.out-14').innerHTML = data.value;
}
...
function f15() {
	...
	document.querySelector('.t-15').innerHTML = data.value;
	document.querySelector('.out-15').innerHTML = data.value;
}
...
function f16() {
	...
	let data = document.querySelector('.s-16');
	document.querySelector('.out-16').innerHTML = data.value;
}
...
function f19() {
	let divText = document.querySelector('.out-19');
	document.querySelector('.i-19').value = divText.textContent;
}
...
function f20() {
	let firstSelect = document.querySelector('.s-201');
	let secondSelect = document.querySelector('.s-202');
