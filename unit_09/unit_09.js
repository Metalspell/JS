...
function f3() {
  ...
  elem.classList.remove('bg-orange');
}
...
function f5() {
  let elem = document.querySelector('.out-4');
  let result = elem.classList.contains("bg-orange");
...
function f6() {
  let elems = document.querySelectorAll('.p-6');
  document.querySelector('.out-6').innerHTML = elems.length;
}
...
function f11() {
  ...
  wrapp.innerHTML = '25';
  document.querySelector('.out-11').appendChild(wrapp);
}
...
function f12() {
  let wrapp = document.createElement('div');
  wrapp.innerHTML = '25';
  wrapp.classList.add('bg-12');
  document.querySelector('.out-12').appendChild(wrapp);
}
...
function f13() {
  let wrapp = document.createElement('div');
  wrapp.innerText = 'pushMe';
  wrapp.classList.add('bg-orange');
  document.querySelector('.out-13').appendChild(wrapp);
  wrapp.onclick = f13_1;
}
...
function f18() {
  let elem = document.querySelector('.p-18');
  document.querySelector('.out-18').innerHTML = elem.getAttribute('data-b');
}
...
function f19() {
  ...
  for (let i = 0; i < elem.length; i++) {
    result += elem[i].getAttribute('data-b') + ' ';
  }
...
function f20() {
  let elem = document.querySelector('.out-20');
  elem.setAttribute('title', 'go');
}
