...
function f1() {
  let data = document.querySelector('.i-1');
  d1.push(data.value);
  showArr('.out-1', d1);
}
...
function f5() {
  let data = document.querySelector('.i-5');
  d1.unshift(data.value);
  showArr('.out-5', d1);
}
...
function f8() {
  let data = document.querySelector('.i-8');
  let temp = [];
  temp[0] = data.value;
...
function f12() {
  let data = document.querySelector('.i-12');
  data = +data.value;
  let out = '';
...
function f18() {
  let data = document.querySelector('.i-18');
  data = data.value;
  let out = d18.includes(data)
...
function f19() {
  ...
  for (let i = 0; i < d19.length; i++) {
    if (d19[i].length > maxLength) {
      maxLength = d19[i].length;
      result = d19[i];
    }
  }
