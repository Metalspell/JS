...
function f6() {
  let objKey = document.querySelector('.i-61');
  objKey = objKey.value;
  let objParam = document.querySelector('.i-62');
  objParam = objParam.value;
  a6[objKey] = objParam;
  f5(a6, '.out-6');
}
...
function f7() {
  let out = '';
  let objKey = document.querySelector('.i-7');
  objKey = objKey.value;
  for (key in a7) {
    if (key == objKey) {
      out = 1;
...
function f8() {
  let out = '';
  let objKey = document.querySelector('.i-8');
  objKey = objKey.value;
  for (key in a8) {
    if (key == objKey) {
      out = a8[key];
...
function f9() {
  let out = '';
  let objKey = document.querySelector('.i-9');
  objKey = objKey.value;
  for (key in a9) {
    if (a9[key] == objKey) {
      out += key + ' ';
...
function f11() {
  let objKey = document.querySelector('.i-11');
  objKey = objKey.value;
...
function f12() {
  let objVal = document.querySelector('.i-12');
  objVal = objVal.value;
...
function f15() {
  let out = '';
  for (let key in a15) {
    for (let k = 0; k < a15[key].length; k++) {
      out += `${a15[key][k]} `;
    }
  }
...
function f18() {
  let out = '';
  let objKey = document.querySelector('.i-18');
  objKey = objKey.value;

  for (let key in a18) {
    if (key === objKey.toLowerCase()) {
...
function f19() {
  let out = '';
  let objKey = document.querySelector('.i-19');
  objKey = objKey.value;
  objKey = objKey[0].toUpperCase() + objKey.substr(1)
