...
function t1() {
  let data = document.querySelector('.div-1');
  document.querySelector('.out-1').innerHTML = data.innerHTML;
}
...
// Task 3 ============================================
/*  Добавьте на блок .div-3 событие клик. При клике - увеличивайте ширину блока на 5px. Каждый клик - увеличение ширины на 5px. 10 кликов - на 50px. 
...
function t6() {
  let data = document.querySelector('.ul-6');
...
function t15() {
  let counter = document.querySelector('.div-15').innerHTML;
  counter++;
...
function t16() {
  let counter = document.querySelector('.div-16').offsetWidth;
  counter++;
  document.querySelector('.div-16').style.width = counter + 'px';
}
...
function t18() {
  let widthParam = document.querySelector('.div-18').offsetWidth;
  document.querySelector('.div-18').innerHTML = widthParam;
}
...
function t19() {
  let list = document.querySelector('.div-19').classList;
  list.forEach(element => {
    document.querySelector('.div-19').innerHTML += element;
  });
}
...
function t20() {
  let counter = this.getAttribute('value');
  counter++;
  this.setAttribute('value',counter);
}
