...
function t1() {
  ...
  myXhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=1", true);
  myXhttp.send();
...
function t2() {
  ...
  myXhttp.open("GET", "http://getpost.itgid.info/index2.php?name=Dmitry&auth=DdC33D7d2C2a7&action=2", true);
  myXhttp.send();
...
function t3() {
  ...
  myXhttp.open("GET", "http://getpost.itgid.info/index2.php?num1=4&num2=5&auth=DdC33D7d2C2a7&action=3", true);
  myXhttp.send();
...
function t4() {
  ...
  myXhttp.open("GET", "http://getpost.itgid.info/index2.php?num1=1&num2=10&auth=DdC33D7d2C2a7&action=4", true);
  myXhttp.send();
...
function t5() {
  ...
  myXhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=5");
  myXhttp.send();
...
function t6() {
  ...
  myXhttp.open("GET", "http://getpost.itgid.info/index2.php?num1=1&num2=10&auth=DdC33D7d2C2a7&action=6", true);
  myXhttp.send();
...
function t7() {
  ...
  myXhttp.open("GET", "http://getpost.itgid.info/index2.php?num1=1&num2=10&auth=DdC33D7d2C2a7&action=7", true);
  myXhttp.send();
...
function t8() {
  ...
  myXhttp.open("GET", "http://getpost.itgid.info/index2.php?year=1987&auth=DdC33D7d2C2a7&action=8", true);
  myXhttp.send();
...
function t9() {
  ...
  myXhttp.open("GET", "http://getpost.itgid.info/index2.php?&m=1&d=1&y=1&auth=DdC33D7d2C2a7&action=9", true);
  myXhttp.send();
...
function t10() {
  ...
  myXhttp.open("POST", "http://getpost.itgid.info/index2.php?", true);
  myXhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  myXhttp.send('auth=DdC33D7d2C2a7&action=1');
...
function t11() {
  ...
  myXhttp.open("POST", "http://getpost.itgid.info/index2.php?", true);
  myXhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  myXhttp.send('&name=Dmitry&auth=DdC33D7d2C2a7&action=2');
...
function t12() {
  ...
  myXhttp.open("POST", "http://getpost.itgid.info/index2.php?", true);
  myXhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  myXhttp.send('&num1=1&num2=9&auth=DdC33D7d2C2a7&action=3');
...
function t13() {
  ...
  myXhttp.open("POST", "http://getpost.itgid.info/index2.php?", true);
  myXhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  myXhttp.send('&num1=1&num2=9&auth=DdC33D7d2C2a7&action=4');
...
function t14() {
  ...
  myXhttp.open("POST", "http://getpost.itgid.info/index2.php?", true);
  myXhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  myXhttp.send('auth=DdC33D7d2C2a7&action=5');
...
function t15() {
  ...
  myXhttp.open("POST", "http://getpost.itgid.info/index2.php?", true);
  myXhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  myXhttp.send('&num1=10&num2=20&auth=DdC33D7d2C2a7&action=6');
...
function t16() {
  ...
  myXhttp.open("POST", "http://getpost.itgid.info/index2.php?", true);
  myXhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  myXhttp.send('auth=DdC33D7d2C2a7&action=7');
...
function t17() {
  ...
  myXhttp.open("POST", "http://getpost.itgid.info/index2.php?", true);
  myXhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  myXhttp.send('year=1987&auth=DdC33D7d2C2a7&action=8');
...
function t18() {
  ...
  myXhttp.open("POST", "http://getpost.itgid.info/index2.php?", true);
  myXhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  myXhttp.send('&m=1&d=1&y=1&year=1987&auth=DdC33D7d2C2a7&action=9');
