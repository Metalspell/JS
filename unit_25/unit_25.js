...
const ourPath = 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7';

function t1() {
  fetch(`${ourPath}&action=1`, {
...
function t2() {
  fetch(`${ourPath}&name=Dmitry&action=2`, {
    method: 'GET', // *GET, POST, PUT, DELETE, etc.
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
    },
...
function t3() {
  fetch(`${ourPath}&num1=2&num2=3&action=3`, {
    method: 'GET', // *GET, POST, PUT, DELETE, etc.
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
    },
...
function t4() {
  fetch(`${ourPath}&num1=2&num2=30&action=4`, {
    method: 'GET', // *GET, POST, PUT, DELETE, etc.
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
    },
...
function t6() {
  fetch(`${ourPath}&num1=2&num2=30&action=6`, {
    method: 'GET', // *GET, POST, PUT, DELETE, etc.
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
    },
...
function t8() {
  fetch(`${ourPath}&year=1987&action=8`, {
    method: 'GET', // *GET, POST, PUT, DELETE, etc.
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
    },
...
function t9() {
  fetch(`${ourPath}&m=1&d=1&y=1&year=1987&action=9`, {
    method: 'GET', // *GET, POST, PUT, DELETE, etc.
    headers: {
      'Content-Type': 'application/x-www-form-urlencoded',
    },
...
function t11() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: 'name=Dmitry&auth=DdC33D7d2C2a7&action=2',
  })
    .then(response => response.text())
    .then(response => {
...
function t12() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: '&num1=2&num2=30&auth=DdC33D7d2C2a7&action=3',
  })
    .then(response => response.text())
    .then(response => {
...
function t13() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: '&num1=2&num2=30&auth=DdC33D7d2C2a7&action=4',
  })
    .then(response => response.text())
    .then(response => {
...
function t14() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: '&num1=2&num2=30&auth=DdC33D7d2C2a7&action=5',
  })
    .then(response => response.text())
    .then(response => {
...
function t15() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: '&num1=2&num2=30&auth=DdC33D7d2C2a7&action=6',
  })
    .then(response => response.text())
    .then(response => {
...
function t16() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: '&num1=2&num2=30&auth=DdC33D7d2C2a7&action=7',
  })
    .then(response => response.text())
    .then(response => {
...
function t17() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: '&year=1987&auth=DdC33D7d2C2a7&action=8',
  })
    .then(response => response.text())
    .then(response => {
...
function t18() {
  fetch("http://getpost.itgid.info/index2.php", {
    ...
    body: '&m=1&d=1&y=1&auth=DdC33D7d2C2a7&action=9',
  })
    .then(response => response.text())
    .then(response => {
